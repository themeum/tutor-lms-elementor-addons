...
<div class="tutor-single-course-segment etlms-course-description">
    ...
    <div class="tutor-course-content-content">
        <?php if (\Elementor\Plugin::instance()->editor->is_edit_mode()) {
            echo __('This is demo content for preview purposes. Dynamic content will be viewable from the frontend once you have published the course and template.', 'tutor-elementor-addons');
        } else {
            the_content();
        } ?>
    </div>
