					...
					" style="<?php echo esc_attr( $dynamic_style ); ?>">
						...
						<!--header end--> 
							...
							<div class="etlms-carousel-course-container">
								...
								<?php if ( $settings['course_list_column'] < 2 || 'stacked' === $settings['course_list_skin'] || 'overlayed' === $settings['course_list_skin'] ) : ?>
							...
							<?php if ( $settings['course_list_column'] > 1 && ( 'classic' === $settings['course_list_skin'] || 'card' === $settings['course_list_skin'] ) ) : ?>
								<div class="tutor-course-listing-item-footer has-border tutor-py-15 tutor-px-20 tutor-loop-course-footer etlms-carousel-footer <?php echo esc_html( $enroll_btn_type ); ?>" style="
									<?php if ( $is_footer == 'yes' ) : ?>
										display:block;
										<?php else : ?>
