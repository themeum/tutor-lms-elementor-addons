			...
			<?php foreach ( $rating->count_by_value as $key => $value ) : ?>
				...
				<div class="rating-numbers">
					...
					<div class="rating-num tutor-text-regular-caption tutor-color-text-subsued">
						<?php
							echo esc_html( $value . ' ' );
							echo esc_html( $value > 1 ? __( 'ratings', 'tutor-lms-elementor-addons' ) : __( 'rating', 'tutor-lms-elementor-addons' ) );
						?>
					</div>
				</div>
			<?php endforeach; ?>
			...
			foreach ( $reviews as $review ) {
				...
				?>
					<li>
						<div>
							<div class="">
								<img class="tutor-avatar-circle tutor-50" src="<?php echo esc_url( get_avatar_url( $review->user_id ) ); ?>" alt="student avatar" />
							</div>
							<div class="text-regular-body tutor-color-text-primary tutor-mt-16">
								...
								<?php echo esc_html( '' !== $review->display_name ? $review->display_name : $review->user_login ); ?>
								</a>
							</div>
